...
class Clip{
  ...
  constructor(wpId,$vm){
    ...
    this.editBox = document.createElement('canvas');//编辑
  ...
  paintImg(picUrl){
    ...
    img.onload = function() {
      ...
      let imgScale = img.width / img.height; //宽：高
      let boxScale = t.regional.offsetWidth / t.regional.offsetHeight; //画布的宽：高
  ...
  save(){
    ...
    t.drawImageIOSFix(ctx, images,cropWidthScale * t.sx , cropHeightScale* t.sy,
                    t.sWidth * cropWidthScale, t.sHeight * cropHeightScale, 0, 0, 300, 300);
